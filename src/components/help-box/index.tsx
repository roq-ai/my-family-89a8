...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Family Admin'];
  const customerRoles: string[] = ['Emergency Contact'];
  const tenantRoles: string[] = ['Extended Family Member', 'Family Member', 'Family Admin'];
  const addOns: string[] = ['chat', 'file', 'notifications'];
  const applicationName = `My Family`;
